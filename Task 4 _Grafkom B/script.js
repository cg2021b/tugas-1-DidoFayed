...
const bgTexture = loaderEnv.load([
    './environment/px.png',
    './environment/nx.png',
    './environment/py.png',
    './environment/ny.png',
 ...
 */
 ...
 const materialDisco = new THREE.MeshPhysicalMaterial( {wireframe: false, map: loaderTexture.load('./environment/panorama.jpg')} );
 materialDisco.color = new THREE.Color(0xfafafa);
